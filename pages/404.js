    ...
    <>
        <div className='bg-[#eee]'>
            ...
            <div className='2xl:container 2xl:mx-auto bg-white font-ableton font-bold -mt-1 2xl:mt-0'>
                ...
                <p className='lg:px-32 lg:pb-32 lg:mt-10 2xl:text-3xl text-xl lg:text-2xl mt-5 px-10 pb-20'>You could go back to the<a href='/' className='text-[#0000ff]'>&nbsp;home page.</a></p>
            </div>
            <Footer/>
        </div>
    </>
